...
<head>
  ...
  <style>
    body {
      ...
      background-image: url('https://i.pinimg.com/originals/2e/4f/3c/2e4f3c9e3f6e4b6a3f3c8e6f2e3c4f9e.jpg');
    ...
    .btn-red {
      background: linear-gradient(to right, #a97474, #c19a7e);
      color: white;
    }
    .btn-red:hover {
    ...
    .input-red {
      background-color: rgba(250, 240, 235, 0.85);
    }
    .input-red:hover {
    ...
    .border-pink-200 { border-color: #7b2e2e; }
    .shadow-2xl { box-shadow: 0 0 25px rgba(60, 50, 50, 0.4); }
    .text-pink-900 { color: #4b1e1e; }
    .text-pink-700 { color: #7b2e2e; }
    .bg-pink-50\/80 { background-color: rgba(240, 235, 230, 0.8); }
    .hover\:bg-pink-100:hover { background-color: rgba(220, 210, 200, 0.5); }
    .border-pink-300 { border-color: #a05252; }
    .focus\:ring-pink-500:focus { --tw-ring-color: #a05252; }
    .placeholder-pink-400::placeholder { color: #a05252; }
    .btn-pink { @apply btn-red; }
    .input-pink { @apply input-red; }
  </style>
</head>
